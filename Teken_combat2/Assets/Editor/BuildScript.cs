...
{
    // Unity Cloud Build invoca esto en "Post-Export Method"
    public static void PerformServerBuild()
    {
        ...
        var opts = new BuildPlayerOptions {
            ...
            // si te da warning, cámbialo por StandaloneBuildSubtarget.Server
        ...
        if (report.summary.result == BuildResult.Succeeded)
            Debug.Log("✅ Build Linux completado en: " + buildPath);
        else {
